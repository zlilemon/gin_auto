...
func handleFields(l *zap.Logger, args []interface{}, additional ...zap.Field) []zap.Field {
	...
	if len(args) == 0 {
		// fast-core if we have no suggared fields.
		return additional
	}
...
func New(opts *Options) *zapLogger {
	...
	if opts.Formatter == ConsoleFormat && opts.EnableColor {
...
// CheckIntLevel used for other log wrapper such as klog which core if logging a
